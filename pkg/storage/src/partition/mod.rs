...
use crate::*;
use crate::common::BlockTrait;
use crate::common::BlockDevice;
    ...
    B: BlockTrait,
{
    ...
    fn read_block(&self, offset: usize, block: &mut B) -> Result<()> {
        ...
        // FIXME: calculate the block offset for inner 
        let re_offset = self.offset + offset;
        // FIXME: read from the inner device
        self.inner.read_block(re_offset, block)
    ...
    fn write_block(&self, offset: usize, block: &B) -> Result<()> {
        ...
        self.inner.write_block(re_offset, block)
